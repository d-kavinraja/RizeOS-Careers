...
export default function DashboardPage() {
  ...
  const handleApplyToRecommendation = (jobId: number) => {
    router.push(`/jobs?apply=${jobId}`)
    toast({
      title: "Redirecting to Application",
      description: "Taking you to apply for this recommended position...",
    })
  }
                  ...
                  {recommendations.map((rec) => (
                    ...
                    >
                      ...
                      <div className="flex flex-row md:flex-col items-start md:items-end space-x-4 md:space-x-0 md:space-y-2">
                        ...
                        <Button size="sm" onClick={() => handleApplyToRecommendation(rec.id)}>
                          Apply Now
                        </Button>
                      </div>
                    </div>
